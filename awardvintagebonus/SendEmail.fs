...
type EmailAccess() =
    ...
    member this.SendBonusReqUserReceipt(fromGmailUser: string)(fromGmailPwd : string)(userEmail : string)(firstName : string)(amount: string) =
        ...
        let msg = MimeMessage()
        msg.From.Add(MailboxAddress ("Help", "help@greenzorro.com"))
