...
module GmRptFiles =
    ...
    type BegBalanceFilenameType = string
    type EndBalanceFilenameType = string
    ...
    type BegBalanceStrDateType = string
    type EndBalanceStrDateType = string
    ...
    type BegBalanceDateType = DateTime
    type EndBalanceDateType = DateTime
