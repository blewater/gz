CREATE TABLE [dbo].[CustFundShares] (
    ...
    CONSTRAINT [FK_dbo.CustFundShares_dbo.InvBalances_SoldInvBalanceId] FOREIGN KEY ([SoldInvBalanceId]) REFERENCES [dbo].[InvBalances] ([Id])
);


GO
CREATE NONCLUSTERED INDEX [IX_SoldInvBalanceId]
    ON [dbo].[CustFundShares]([SoldInvBalanceId] ASC);
