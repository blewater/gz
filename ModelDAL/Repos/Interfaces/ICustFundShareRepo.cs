...
namespace gzDAL.Repos.Interfaces
{
    public interface ICustFundShareRepo
    {
        ...
        void SaveDbCustPurchasedFundShares(int customerId, Dictionary<int, CustFundShareRepo.PortfolioFundDTO> fundsShares, int year, int month, DateTime updatedOnUTC);
    }
}