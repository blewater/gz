...
namespace gzDAL.Conf {
    ...
    public class TestSeeder {
        ...
        private static void CreateUpdGzTransaction(TestDbContext context, int custId) {
            ...
            // Use new API
            trxRepo.SaveDbPlayingLoss(custId, 1000, "201503", new DateTime(2015, 3, 31, 23, 46, 01), 5000, 1000, 1000, 2000, 3000);
            trxRepo.SaveDbPlayingLoss(custId, 1000, "201503", new DateTime(2015, 4, 29, 23, 56, 12, 42), 5000, 1000, 1000, 2000, 3000);
