(function () {
    ...
    APP.controller(ctrlId, ['$rootScope', '$scope', '$location', 'constants', ctrlFactory]);
    function ctrlFactory($rootScope, $scope, $location, constants) {        
        function initializeMobileCheck(){
