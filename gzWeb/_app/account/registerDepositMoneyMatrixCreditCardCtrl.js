(function () {
    ...
    APP.controller(ctrlId, ['$scope', '$rootScope', '$filter', 'emBanking', '$q', 'iso4217', 'constants', '$timeout', 'message', 'auth', ctrlFactory]);
    function ctrlFactory($scope, $rootScope, $filter, emBanking, $q, iso4217, constants, $timeout, message, auth) {
