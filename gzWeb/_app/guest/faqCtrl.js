(function () {
    'use strict';
    var ctrlId = 'faqCtrl';
    APP.controller(ctrlId, ['$scope', '$sce', 'cms', ctrlFactory]);
    function ctrlFactory($scope, $sce, cms) {
        ...
        (function init() {
            cms.content.retrieve(['about_greenzorro', 'faq_items'])
                .then((res) => {

                    var agitems = res.data.data.faq_items;
                    var a0 = { Q: agitems[1]["q"], A: agitems[1]["a"] };
                    var a1 = { Q: agitems[0]["q"], A: agitems[0]["a"] };
                    ...
                    //this.faq.title = res.data.data.about_greenzorro;
